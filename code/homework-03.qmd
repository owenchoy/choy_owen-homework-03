...
ggplot() +
  ...
  geom_errorbar(data = model_preds_for_plotting, # confidence intervals
                aes(x = water_treatment,
                    ymin = conf.low, # given CI boundaries
                    ymax = conf.high,
                    alpha = 0.1),
                width = 0.15) + # width of CI bars
  # geom_ribbon(data = model_preds_for_plotting, # model prediction 95% CI ribbon
  #             aes(x = water_treatment, 
  #                 y = predicted,
  #                 ymin = conf.low, # low CI
  #                 ymax = conf.high, # high CI
  #                 group = species_name),
  #             alpha = 0.2) + # transparency
  geom_line(data = model_preds_for_plotting, # model prediction lines
            aes(x = water_treatment, 
                y = predicted,
                group = species_name,
                color = "lightgreen")) + # color prediction line
