...
plot(model_preds1, # model predictions
...
model_preds_for_plotting1 <- model_preds1 %>% 
...
ggplot() +
  ...
  geom_ribbon(data = model_preds_for_plotting1,
              aes(x = sla, 
                  y = predicted,
                  ymin = conf.low,
                  ymax = conf.high,
  ...
  geom_line(data = model_preds_for_plotting1,
            aes(x = sla, 
                y = predicted,
                color = water_treatment)) +
  # cleaner theme
