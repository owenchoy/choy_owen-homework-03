...
Out of the four models we have tried, the best model is the one that includes **all predictors (SLA, water treatment, and species**
...
**reference for species_name:** **species_nameAgnispan glaber**

Interpret the model estimates for the:

-   intercept: **mass of Acmispan glaber in drought stressed treatment when SLA = 0**\
-   SLA slope: **across drought treatements and species, with each 1 unit increase in SLA (mm^2^/dry mass of leaf), we expect an increase in total mass of -0.00025 which means with the estimate and standard error there is no effect of SLA on total mass (because large p-value, small t-value, and estamite ± SE overlaps with 0**\
-   well watered estimate: **across species and SLA, well watered plants tend to be 0.12 ± 0.02 g heavier than drought stressed plantse**\
