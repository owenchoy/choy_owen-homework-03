...
**Leaf dry weight is strongly positively correlated with shoot mass (Pearson’s r = 0.438).**

**Specific leaf area (sla) is highly positively correlated with root mass (Pearson’s r = 0.460).**

**Shoot mass is highly positively correlated with total mass (Pearson’s r = 0.902).**
...
**Plants with larger biomass seem to have larger ranges. Grindelia camporum has the highest mean total mass, while Acmispon glaber has the lowest mean total mass.**
...
**Well watered treatments correlate with a higher mean total mass, whereas drought stressed treatments correlate with a lower mean total mass.**
...
**Specific leaf area correlates with a higher mean total mass.**

# Model construction

What is the null model?

0.  **Model where the total mass is not predicted by SLA, water treatment, or species.**

What is the saturated model?

1.  **A model where the total mass is predicted by SLA, water treatment, and species**
...
diagnostics for model1 (saturated model: all 3) look good
...
diagnostics for model2 (SLA + water treatment) look good
...
diagnostics for model3 (SLA + species) look good
...
diagnostics for model4 (water treatment + species) look good
...
Out of the four models we have tried, the best model is the one that includes **all predictors (SLA, water treatment, and species). However, the 5th model (model4) ended up being the best.**
...
-   SLA slope: **across drought treatments and species, with each 1 unit increase in SLA (mm^2^/dry mass of leaf), we expect an increase in total mass of -0.00025 which means with the estimate and standard error there is no effect of SLA on total mass (because large p-value, small t-value, and estimate ± SE overlaps with 0**\
...
-   Lotus scoparius estimate: **across water treatments and SLA OR on average, Lotus scoparius plants were -0.23 ± 0.032 g less than Encelia californica.**\
-   Stipa pulchra estimate: **across water treatments and SLA or on average, Stipa pulchra plants are the same size as Encelia californica plants**
